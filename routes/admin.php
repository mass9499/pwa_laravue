...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
	...
	Route::get('/', 'AdminController@admin_dashboard')->name('admin.dashboard')->middleware('permission:show_staff_roles');

	Route::post('/language', 'LanguageController@changeLanguage')->name('language.change')->middleware('permission:show_staff_roles');;
